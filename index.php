...
<div class="content bg-white">
    <div class="row push-3-t push-3">
     ...
     <center>     <p><marquee onmouseover="this.stop()" onmouseout="this.start()" scrollamount="3" scrolldelay="60" direction="right"><b><a  title="" target="_blank"></a></b><b><a title="" target="_blank"><span id="movetitle"><i class="ti-heart"></i> مرحبا بك في لوحة التيم سبيك , تم انشاء هذه اللوحة لأعطائك صلاحيات تمكنك من التحكم في عضويتك بكل سهولة , اللوحة لازالت تحت التطوير , كرر زيارتك مرة اخرى</span></a> </b><b><a  title="" target="_blankB.#" لاتزال="" اللوحة="" تحت="" التطوير="" والبرمجة)="" ..<="" a="">   </a></b></marquee></p>
		  </center>
        </div>
</div>
